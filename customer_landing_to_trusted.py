...
CustomerLanding_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    connection_type="s3",
    format="json",
    connection_options={"paths": ["s3://stedi-s3/customer/landing/"], "recurse": True,"enableUpdateCatalog": True},
...
CustomerTrusted_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    format="json",
    connection_options={"path": "s3://stedi-s3/customer/trusted/", "partitionKeys": [],"enableUpdateCatalog": True},
